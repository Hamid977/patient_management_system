...
<head>
    ...
    <title>Klinikal Health care- Create Account</title>
    <meta name="Description" content="Klinikal Health care">
                    ...
                    <div class="tbl-row">
                        <div class="tbl-cell hdr-logo">
                            <a href="http://pepdev.com/theme-preview/klinikal/index.php?route=home">
                                <img src="uploads/logo-blue.png" alt="Klinikal Health care">
                            </a>
                        </div>
    ...
    <div class="layer-stretch">
        <div class="page-ttl-container">
            ...
            <div class="page-ttl-name">
                <h1>Register</h1>
                <p><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=home">Home</a> > Register</p>
            </div>
        </div>
    </div>
            ...
            <div class="layer-container">
                <form class="form-container" action="http://pepdev.com/theme-preview/klinikal/index.php?route=register" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon form-bot-check">
                        ...
                        <label class="mdl-textfield__label" for="register-bot">What is 10 plus 3 = <em> *</em></label>
                        <span class="mdl-textfield__error">Please Enter Correct Value!</span>
                    </div>
                    <div class="login-condition">By clicking Creat Account you aggree to our<br /><a href="http://pepdev.com/theme-preview/klinikal/index.php?route=terms-condition">Terms & Condition</a></div>
...
City, Country Pin Code</p>
	...
	<script>$('#menu-register').addClass('active');</script>	<!-- Custom Css -->
	<style></style>
